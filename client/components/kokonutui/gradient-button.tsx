...
export default function GradientButton({
  ...
  return (
    <Button
      variant='ghost'
      className={cn(
        'group relative h-12 px-4 rounded-lg overflow-hidden transition-all duration-500 cursor-pointer',
        className
      )}
      {...props}
    >
      <div
        className={cn(
          'absolute inset-0 rounded-lg p-0.5 bg-linear-to-b',
          'dark:bg-none',
          colors.light.border,
          colors.dark.border
        )}
      ...
      <div
        className={cn(
          'absolute inset-0.5 bg-linear-to-r rounded-lg opacity-90',
          colors.light.base,
      ...
      <div
        className={cn(
          'absolute inset-0.5 bg-linear-to-b rounded-lg opacity-80',
      ...
      <div
        className={cn(
          'absolute inset-0.5 bg-linear-to-br rounded-lg',
          colors.light.accent,
          colors.dark.accent
        )}
      />
      ...
      <div className='relative flex items-center justify-center gap-2'>
        {Icon && <Icon className='h-5 w-5 text-green-400' />}
        <span
          className={cn(
      ...
      <div
        className={cn(
          'absolute inset-0.5 opacity-0 transition-opacity duration-300 bg-linear-to-r group-hover:opacity-100 rounded-lg',
          colors.light.hover,
          colors.dark.hover
        )}
      />
